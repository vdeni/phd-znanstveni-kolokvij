...
\begin{frame}
    \centering
    \includegraphics[scale=.26]{orben.png}
...
\begin{frame}
    \begin{center}
        \begin{minipage}{25em}
            ...
            \citep{elliottWhatTestRetestReliability2020}
        \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{minipage}{24em}
        The empiricist period [\ldots] is characterized by a general
        lack of interest in stringent theoretical and metatheoretical thinking.
        [\ldots]  Industrious research appears to be mainly driven by available
        research tools [\ldots], methods of analysis [\ldots], and the dynamics
